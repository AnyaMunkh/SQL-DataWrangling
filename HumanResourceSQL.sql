/* For this SQL project I will be showcasing my skill to create a temporary table with the data I extracted
from 9 different relational tables 
and then solving 9 questions from the table I created */
